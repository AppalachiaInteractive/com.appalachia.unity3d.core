...
namespace Appalachia.Core.Volumes
{
    ...
    /// <summary>
    ///     The base class for all parameters types stored in a <see cref="AppaVolumeComponent" />.
    /// </summary>
    /// <seealso cref="AppaVolumeParameter{T}" />
    [Serializable]
    public abstract class AppaVolumeParameter
    {
        ...
        /// <summary>
        ///     The current override state for this parameter. The AppaVolume system considers overriden parameters
        ...
        /// </summary>
        /// <param name="parameter">The <see cref="AppaVolumeParameter" /> to copy the value from.</param>
        public abstract void SetValue(AppaVolumeParameter parameter);
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="type" /> is an <see cref="ObjectParameter{T}" />,
        ///     <c>false</c> otherwise.
        /// </returns>
        ...
        /// <summary>
        ///     Unity calls this method when the parent <see cref="AppaVolumeComponent" /> goes out of scope.
        /// </summary>
        ...
        /// <summary>
        ///     Unity calls this method when the parent <see cref="AppaVolumeComponent" /> loads.
        /// </summary>
        /// <remarks>
        ///     Use this if you need to access fields and properties that you can not access in
        ///     the constructor of a <c>ScriptableObject</c>. (<see cref="AppaVolumeParameter" /> are
        ///     generally declared and initialized in a <see cref="AppaVolumeComponent" />, which is a
        ///     <c>ScriptableObject</c>). Unity calls this right after it constructs the parent
        ///     <see cref="AppaVolumeComponent" />, thus allowing access to previously
    ...
    /// <summary>
    ///     A generic implementation of <see cref="AppaVolumeParameter" />. Custom parameters should derive
    ...
    ///     directly to declare parameters in a <see cref="AppaVolumeComponent" />. Instead, use one of the
    ...
    /// 
    /// [Serializable]
    /// public sealed class MyFloatParameter : AppaVolumeParameter&lt;float&gt;
    /// {
    ...
    public class AppaVolumeParameter<T> : AppaVolumeParameter, IEquatable<AppaVolumeParameter<T>>
    {
        ...
        /// </summary>
        /// <param name="lhs">The first value in a <see cref="AppaVolumeParameter" />.</param>
        ...
        /// <summary>
        ///     Explicitly downcast a <see cref="AppaVolumeParameter{T}" /> to a value of type
        ///     <typeparamref name="T" />.
        /// </summary>
        /// <param name="prop">The parameter to downcast.</param>
        /// <returns>A value of type <typeparamref name="T" />.</returns>
        public static explicit operator T(AppaVolumeParameter<T> prop)
        {
            return prop.m_Value;
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                if (!EqualityComparer<T>.Default.Equals(
                        value,
                        default
                    )) // Catches null for references with boxing of value types
                {
        ...
        /// </summary>
        /// <param name="parameter">The <see cref="AppaVolumeParameter" /> to copy the value from.</param>
        public override void SetValue(AppaVolumeParameter parameter)
        {
        ...
        #region IEquatable<AppaVolumeParameter<T>> Members
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>bool</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class BoolParameter : AppaVolumeParameter<bool>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>LayerMask</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class LayerMaskParameter : AppaVolumeParameter<LayerMask>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds an <c>int</c> value.
    /// </summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>int</c> value.
    /// </summary>
    ...
    /// <seealso cref="NoInterpClampedIntParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpIntParameter : AppaVolumeParameter<int>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds an <c>int</c> value clamped to a
    ///     minimum value.
    /// </summary>
    /// <seealso cref="IntParameter" />
    /// <seealso cref="MaxIntParameter" />
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>int</c> value that
    ...
    /// <seealso cref="NoInterpClampedIntParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpMinIntParameter : AppaVolumeParameter<int>
    {
        /// <summary>
    ...
    /// <seealso cref="NoInterpClampedIntParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpMaxIntParameter : AppaVolumeParameter<int>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds an <c>int</c> value clamped between a
    ...
    /// <seealso cref="NoInterpMaxIntParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpClampedIntParameter : AppaVolumeParameter<int>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>float</c> value.
    /// </summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>float</c> value.
    /// </summary>
    ...
    /// <seealso cref="NoInterpFloatRangeParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpFloatParameter : AppaVolumeParameter<float>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>float</c> value clamped to a minimum value.
    /// </summary>
    /// <seealso cref="FloatParameter" />
    /// <seealso cref="MaxFloatParameter" />
    /// <seealso cref="ClampedFloatParameter" />
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>float</c> value clamped to
    ///     a minimum value.
    /// </summary>
    /// <seealso cref="FloatParameter" />
    /// <seealso cref="MinFloatParameter" />
    ...
    /// <seealso cref="NoInterpFloatRangeParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpMinFloatParameter : AppaVolumeParameter<float>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>float</c> value clamped to a max value.
    /// </summary>
    /// <seealso cref="FloatParameter" />
    /// <seealso cref="MinFloatParameter" />
    /// <seealso cref="ClampedFloatParameter" />
    ...
    /// <seealso cref="NoInterpFloatRangeParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpMaxFloatParameter : AppaVolumeParameter<float>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>float</c> value clamped between a minimum and a
    ///     maximum value.
    /// </summary>
    /// <seealso cref="FloatParameter" />
    /// <seealso cref="MinFloatParameter" />
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>float</c> value clamped between
    ...
    /// <seealso cref="NoInterpFloatRangeParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpClampedFloatParameter : AppaVolumeParameter<float>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>Vector2</c> value holding a range of two
    ...
    /// <seealso cref="NoInterpFloatRangeParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class FloatRangeParameter : AppaVolumeParameter<Vector2>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>Vector2</c> value holding
    ...
    /// <seealso cref="NoInterpClampedFloatParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpFloatRangeParameter : AppaVolumeParameter<Vector2>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>Color</c> value.
    /// </summary>
    /// <seealso cref="NoInterpColorParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class ColorParameter : AppaVolumeParameter<Color>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>Color</c> value.
    /// </summary>
    /// <seealso cref="ColorParameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpColorParameter : AppaVolumeParameter<Color>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>Vector2</c> value.
    /// </summary>
    /// <seealso cref="NoInterpVector2Parameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class Vector2Parameter : AppaVolumeParameter<Vector2>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>Vector2</c> value.
    /// </summary>
    /// <seealso cref="Vector2Parameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpVector2Parameter : AppaVolumeParameter<Vector2>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>Vector3</c> value.
    /// </summary>
    /// <seealso cref="NoInterpVector3Parameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class Vector3Parameter : AppaVolumeParameter<Vector3>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>Vector3</c> value.
    /// </summary>
    /// <seealso cref="Vector3Parameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpVector3Parameter : AppaVolumeParameter<Vector3>
    {
        /// <summary>
        ///     Creates a new <seealso cref="Vector3Parameter" /> instance.
        /// </summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>Vector4</c> value.
    /// </summary>
    /// <seealso cref="NoInterpVector4Parameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class Vector4Parameter : AppaVolumeParameter<Vector4>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>Vector4</c> value.
    /// </summary>
    /// <seealso cref="Vector4Parameter" />
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpVector4Parameter : AppaVolumeParameter<Vector4>
    {
        /// <summary>
        ///     Creates a new <seealso cref="Vector4Parameter" /> instance.
        /// </summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>Texture</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class TextureParameter : AppaVolumeParameter<Texture>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>Texture</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpTextureParameter : AppaVolumeParameter<Texture>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a 2D <c>Texture</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class Texture2DParameter : AppaVolumeParameter<Texture>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a 3D <c>Texture</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class Texture3DParameter : AppaVolumeParameter<Texture>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>RenderTexture</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class RenderTextureParameter : AppaVolumeParameter<RenderTexture>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>RenderTexture</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpRenderTextureParameter : AppaVolumeParameter<RenderTexture>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a <c>Cubemap</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class CubemapParameter : AppaVolumeParameter<Texture>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a non-interpolating <c>Cubemap</c> value.
    /// </summary>
    [Serializable, DebuggerDisplay(k_DebuggerDisplay)]
    public class NoInterpCubemapParameter : AppaVolumeParameter<Cubemap>
    {
        /// <summary>
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds a serializable class or struct.
    /// </summary>
    /// <typeparam name="T">
    ...
    /// <summary>
    ///     A <see cref="AppaVolumeParameter" /> that holds an <c>AnimationCurve</c> value.
    /// </summary>
    [Serializable]
    public class AnimationCurveParameter : AppaVolumeParameter<AnimationCurve>
    {
        /// <summary>
        ...
        /// <param name="overrideState">The initial override state for the parameter</param>
        public AnimationCurveParameter(AnimationCurve value, bool overrideState = false) : base(
            value,
            overrideState
        )
        {
