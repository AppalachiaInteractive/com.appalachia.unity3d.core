...
{
    public sealed class NonSerializedAppaLookup3<TKey1, TKey2, TKey3, TValue> : AppaLookup3<TKey1,
        TKey2, TKey3, TValue, NonSerializedList<TKey1>, NonSerializedList<TKey2>,
        NonSerializedList<TKey3>, NonSerializedList<TValue>, NonSerializedAppaLookup<TKey3, TValue>,
