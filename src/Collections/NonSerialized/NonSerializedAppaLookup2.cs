...
{
    public sealed class NonSerializedAppaLookup2<TKey1, TKey2, TValue> : AppaLookup2<TKey1, TKey2,
        TValue, NonSerializedList<TKey1>, NonSerializedList<TKey2>, NonSerializedList<TValue>,
        ...
        NonSerializedList<NonSerializedAppaLookup<TKey2, TValue>>>
    {
        protected override string GetDisplayTitle(
            TKey1 key,
            NonSerializedAppaLookup<TKey2, TValue> value)
        {
            return key.ToString();
        }
