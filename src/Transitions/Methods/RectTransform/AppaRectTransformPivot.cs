namespace Appalachia.Core.Transitions.Methods.RectTransform
{
    ...
    [UnityEngine.AddComponentMenu(
        ...
        nameof(AppaRectTransformPivot)
    )]
    public class AppaRectTransformPivot : AppaMethodWithStateAndTarget
    {
        ...
        public class State : AppaTransitionStateWithTarget<UnityEngine.RectTransform>
        {
            ...
            {
                Target.pivot = UnityEngine.Vector2.LerpUnclamped(oldValue, Value, Smooth(Ease, progress));
            }
        }
