namespace Appalachia.Core.Transitions.Methods.CanvasGroup
{
    ...
    [UnityEngine.AddComponentMenu(
        ...
        nameof(AppaCanvasGroupBlocksRaycasts)
    )]
    public class AppaCanvasGroupBlocksRaycasts : AppaMethodWithStateAndTarget
    {
        ...
        public class State : AppaTransitionStateWithTarget<UnityEngine.CanvasGroup>
        {
            ...
            [UnityEngine.Serialization.FormerlySerializedAs("BlocksRaycasts")]
