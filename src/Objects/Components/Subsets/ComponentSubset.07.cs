...
{
    /// <summary>
    ///     A subset around seven components, so that they can be put into collections together.
    /// </summary>
    ...
    /// <typeparam name="TComponentN">The seventh subset component.</typeparam>
    ...
    /// <typeparam name="TComponentDataN">Configuration data for seventh subset component.</typeparam>
    [Serializable]
    public abstract class ComponentSubset<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2, TComponent3,
                                          TComponent4, TComponent5, TComponent6, TComponentN, TComponentData1,
                                          TComponentData2, TComponentData3, TComponentData4, TComponentData5,
                                          TComponentData6, TComponentDataN> : ComponentSubset<TComponentSubset,
        TComponentSubsetData, TComponent1, TComponent2, TComponent3, TComponent4, TComponent5, TComponent6,
        ...
        where TComponentDataN : ComponentData<TComponentN, TComponentDataN>, new()
    {
        ...
        [SerializeField] public TComponentN component7;
        ...
        public override void Enable(TComponentSubsetData data)
        {
            using (_PRF_EnableSubset.Auto())
            {
                ...
                EnableComponent(data, component7, data.data7);
            }
        }
            ...
            string subsetGameObjectName)
        {
            using (_PRF_GetOrAddComponents.Auto())
            {
                ...
                GetOrAddComponent(ref component7);
            }
        }
