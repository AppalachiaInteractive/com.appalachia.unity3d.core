...
namespace Appalachia.Core.Objects.Components.Subsets
{
    ...
    ///     <see
    ///         cref="ComponentSubset{TComponentSubset,TComponentSubsetData,TComponent1,TComponent2,TComponent3,TComponent4,TComponent5,TComponent6,TComponent7,TComponent8,TComponentN,TComponentData1,TComponentData2,TComponentData3,TComponentData4,TComponentData5,TComponentData6,TComponentData7,TComponentData8,TComponentDataN}" />
    ///     .
    /// </summary>
    ...
    /// <typeparam name="TComponentN">The ninth component in the subset.</typeparam>
    ...
    /// <typeparam name="TComponentDataN">The ninth configuration data for the corresponding component in the subset.</typeparam>
    [Serializable]
    public abstract class ComponentSubsetData<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2,
                                              ...
                                              TComponent8, TComponentN, TComponentData1, TComponentData2,
                                              TComponentData3, TComponentData4, TComponentData5, TComponentData6,
                                              TComponentData7, TComponentData8, TComponentDataN> :
        ComponentSubsetData<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2, TComponent3, TComponent4,
            TComponent5, TComponent6, TComponent7, TComponent8, TComponentData1, TComponentData2, TComponentData3,
            TComponentData4, TComponentData5, TComponentData6, TComponentData7, TComponentData8>,
        ...
        where TComponentDataN : ComponentData<TComponentN, TComponentDataN>, new()
    {
        ...
        /// </summary>
        [LabelText("$" + nameof(data9Label))]
        [SerializeField]
        [HideIf("@!ShowAllFields && (HideData9 || HideAllFields)")]
        public TComponentDataN data9;

        #endregion

        protected virtual bool HideData9 => false;
        private string data9Label => typeof(TComponentDataN).Name;
        ...
        protected override void OnApply(TComponentSubset subset)
        {
            using (_PRF_OnApply.Auto())
            {
                ...
                ComponentData<TComponentN, TComponentDataN>.RefreshAndApply(ref data9, Owner, subset.component9);
            }
        }
        ...
        protected override void OnInitializeFields(Initializer initializer, Object owner)
        {
            using (_PRF_CreateOrRefresh.Auto())
            {
                ...
                ComponentData<TComponentN, TComponentDataN>.CreateOrRefresh(ref data9, owner);
            }
        }
