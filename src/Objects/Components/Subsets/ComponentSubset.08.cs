...
{
    /// <summary>
    ///     A subset around eight components, so that they can be put into collections together.
    /// </summary>
    ...
    /// <typeparam name="TComponentN">The eighth subset component.</typeparam>
    ...
    /// <typeparam name="TComponentDataN">Configuration data for eighth subset component.</typeparam>
    [Serializable]
    public abstract class ComponentSubset<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2, TComponent3,
                                          TComponent4, TComponent5, TComponent6, TComponent7, TComponentN,
                                          TComponentData1, TComponentData2, TComponentData3, TComponentData4,
                                          TComponentData5, TComponentData6, TComponentData7, TComponentDataN> :
        ...
        where TComponentDataN : ComponentData<TComponentN, TComponentDataN>, new()
    {
        ...
        [SerializeField] public TComponentN component8;
        ...
        public override void Enable(TComponentSubsetData data)
        {
            using (_PRF_EnableSubset.Auto())
            {
                ...
                EnableComponent(data, component8, data.data8);
            }
        }
            ...
            string subsetGameObjectName)
        {
            using (_PRF_GetOrAddComponents.Auto())
            {
                ...
                GetOrAddComponent(ref component8);
            }
        }
