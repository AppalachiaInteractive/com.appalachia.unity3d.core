...
{
    /// <summary>
    ///     A subset around three components, so that they can be put into collections together.
    /// </summary>
    ...
    /// <typeparam name="TComponentN">The third subset component.</typeparam>
    ...
    /// <typeparam name="TComponentDataN">Configuration data for third subset component.</typeparam>
    [Serializable]
    public abstract class ComponentSubset<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2, TComponentN,
                                          TComponentData1, TComponentData2, TComponentDataN> : ComponentSubset<
        TComponentSubset, TComponentSubsetData, TComponent1, TComponent2, TComponentData1, TComponentData2>
        ...
        where TComponentDataN : ComponentData<TComponentN, TComponentDataN>, new()
    {
        ...
        [SerializeField] public TComponentN component3;
        ...
        public override void Enable(TComponentSubsetData data)
        {
            using (_PRF_EnableSubset.Auto())
            {
                ...
                EnableComponent(data, component3, data.data3);
            }
        }
            ...
            string subsetGameObjectName)
        {
            using (_PRF_GetOrAddComponents.Auto())
            {
                ...
                GetOrAddComponent(ref component3);
            }
        }
