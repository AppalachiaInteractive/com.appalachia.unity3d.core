...
namespace Appalachia.Core.Objects.Components.Subsets
{
    ...
    ///     <see
    ///         cref="ComponentSubset{TComponentSubset,TComponentSubsetData,TComponent1,TComponent2,TComponent3,TComponent4,TComponent5,TComponent6,TComponentN,TComponentData1,TComponentData2,TComponentData3,TComponentData4,TComponentData5,TComponentData6,TComponentDataN}" />
    ///     .
    /// </summary>
    ...
    /// <typeparam name="TComponentN">The seventh component in the subset.</typeparam>
    ...
    /// <typeparam name="TComponentDataN">The seventh configuration data for the corresponding component in the subset.</typeparam>
    [Serializable]
    public abstract class ComponentSubsetData<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2,
                                              TComponent3, TComponent4, TComponent5, TComponent6, TComponentN,
                                              TComponentData1, TComponentData2, TComponentData3, TComponentData4,
                                              TComponentData5, TComponentData6, TComponentDataN> :
        ComponentSubsetData<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2, TComponent3, TComponent4,
            TComponent5, TComponent6, TComponentData1, TComponentData2, TComponentData3, TComponentData4,
            TComponentData5, TComponentData6>,
        ...
        where TComponentSubset : ComponentSubset<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2,
            TComponent3, TComponent4, TComponent5, TComponent6, TComponentN, TComponentData1, TComponentData2,
            TComponentData3, TComponentData4, TComponentData5, TComponentData6, TComponentDataN>, new()
        where TComponentSubsetData : ComponentSubsetData<TComponentSubset, TComponentSubsetData, TComponent1,
            TComponent2, TComponent3, TComponent4, TComponent5, TComponent6, TComponentN, TComponentData1,
            TComponentData2, TComponentData3, TComponentData4, TComponentData5, TComponentData6, TComponentDataN>, new()
        ...
        where TComponentDataN : ComponentData<TComponentN, TComponentDataN>, new()
    {
        ...
        protected override void OnApply(TComponentSubset subset)
        {
            using (_PRF_OnApply.Auto())
            {
                ...
                ComponentData<TComponentN, TComponentDataN>.RefreshAndApply(ref data7, Owner, subset.component7);
            }
        }
