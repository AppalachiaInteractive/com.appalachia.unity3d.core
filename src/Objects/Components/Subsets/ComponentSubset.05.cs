...
{
    /// <summary>
    ///     A subset around five components, so that they can be put into collections together.
    /// </summary>
    ...
    /// <typeparam name="TComponentN">The fifth subset component.</typeparam>
    ...
    /// <typeparam name="TComponentDataN">Configuration data for fifth subset component.</typeparam>
    [Serializable]
    public abstract class ComponentSubset<TComponentSubset, TComponentSubsetData, TComponent1, TComponent2, TComponent3,
                                          TComponent4, TComponentN, TComponentData1, TComponentData2, TComponentData3,
                                          TComponentData4, TComponentDataN> : ComponentSubset<TComponentSubset,
        TComponentSubsetData, TComponent1, TComponent2, TComponent3, TComponent4, TComponentData1, TComponentData2,
        TComponentData3, TComponentData4>
        ...
        where TComponentDataN : ComponentData<TComponentN, TComponentDataN>, new()
    {
        ...
        [SerializeField] public TComponentN component5;
            ...
            string subsetGameObjectName)
        {
            using (_PRF_GetOrAddComponents.Auto())
            {
                ...
                GetOrAddComponent(ref component5);
            }
        }
