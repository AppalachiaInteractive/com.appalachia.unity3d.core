...
namespace Appalachia.Core.Objects.Components.Extensions
{
    public static class ComponentSetDataExtensions
    {
        ...
        public static void Apply<TComponentSet, TComponentSetData>(
            ...
            using (_PRF_Apply.Auto())
            {
                Action CreateSubscribableDelegate()
                {
                    void SubscribableDelegate()
                    {
                        ...
                        ApplyInternal(data, set);
                    }

                    return SubscribableDelegate;
                }

                SubscribeAndApply(data, set, CreateSubscribableDelegate);
            }
        }
        ...
        private static void ApplyInternal<TComponentSet, TComponentSetData>(
        ...
        private static void SubscribeAndApply<TComponentSet, TComponentSetData, TO>(
