...
{
    public interface IAvailabilitySet<out T1, out T2, out T3, out T4>
    {
        IAvailabilitySet<T1, T2, T3, T4, TNext> AndBehaviour<TNext>(TNext unused)
            where TNext : SingletonAppalachiaBehaviour<TNext>, ISingleton<TNext>;

        IAvailabilitySet<T1, T2, T3, T4, TNext> AndBehaviour<TNext>()
            where TNext : SingletonAppalachiaBehaviour<TNext>, ISingleton<TNext>;

        IAvailabilitySet<T1, T2, T3, T4, TNext> AndObject<TNext>(TNext unused)
