...
{
    public class AvailabilitySet<T1, T2, T3, T4, T5, T6> :
        BaseAvailabilitySetOf<Action<T1, T2, T3, T4, T5, T6>>,
        IAvailabilitySet<T1, T2, T3, T4, T5, T6>
    {
        ...
        public void CopyTo(AvailabilitySet<T1, T2, T3, T4, T5, T6> other)
        {
        ...
        protected override void OnFullyAvailable(Action<T1, T2, T3, T4, T5, T6> action)
        {
            using (_PRF_OnFullyAvailable.Auto())
            {
                ...
                action(instance1, instance2, instance3, instance4, instance5, instance6);
            }
        }

        private IAvailabilitySet<T1, T2, T3, T4, T5, T6, TNext> And<TNext>(
            Func<AvailabilityData<TNext>> newDataFunction)
        {
            using (_PRF_And.Auto())
            {
                var result = new AvailabilitySet<T1, T2, T3, T4, T5, T6, TNext>(SortOrder)
                {
                    Data1 = Data1,
                    Data2 = Data2,
                    Data3 = Data3,
        ...
        #region IAvailabilitySet<T1,T2,T3,T4,T5,T6> Members

        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, TNext> AndBehaviour<TNext>(TNext unused)
        ...
        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, TNext> AndObject<TNext>(TNext unused)
            where TNext : SingletonAppalachiaObject<TNext>, ISingleton<TNext>
        {
            return And(() => AvailabilityData<TNext>.ForObject<TNext>(SortOrder));
        }

        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, TNext> AndBehaviour<TNext>()
            where TNext : SingletonAppalachiaBehaviour<TNext>, ISingleton<TNext>
        {
            return And(() => AvailabilityData<TNext>.ForBehaviour<TNext>(SortOrder));
        }

        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, TNext> AndObject<TNext>()
            where TNext : SingletonAppalachiaObject<TNext>, ISingleton<TNext>
        {
            return And(() => AvailabilityData<TNext>.ForObject<TNext>(SortOrder));
        }
