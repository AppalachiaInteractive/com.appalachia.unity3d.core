...
{
    public class AvailabilitySet<T1, T2, T3> : BaseAvailabilitySetOf<Action<T1, T2, T3>>,
                                               IAvailabilitySet<T1, T2, T3>
    {
        ...
        /// <inheritdoc />
        public override bool IsFullyAvailable => Data1.IsAvailable && Data2.IsAvailable && Data3.IsAvailable;

        public void CopyTo(AvailabilitySet<T1, T2, T3> other)
        {
        ...
        /// <inheritdoc />
        protected override void OnFullyAvailable(Action<T1, T2, T3> action)
        {
            using (_PRF_OnFullyAvailable.Auto())
            {
                ...
                action(instance1, instance2, instance3);
            }
        }

        private IAvailabilitySet<T1, T2, T3, TNext> And<TNext>(Func<AvailabilityData<TNext>> newDataFunction)
        {
            using (_PRF_And.Auto())
            {
                var result = new AvailabilitySet<T1, T2, T3, TNext>(SortOrder)
                {
                    Data1 = Data1,
                    Data2 = Data2,
                    Data3 = Data3,
                    Data4 = newDataFunction()
                };
        ...
        #region IAvailabilitySet<T1,T2,T3> Members

        public IAvailabilitySet<T1, T2, T3, TNext> AndBehaviour<TNext>(TNext unused)
        ...
        public IAvailabilitySet<T1, T2, T3, TNext> AndObject<TNext>(TNext unused)
        ...
        public IAvailabilitySet<T1, T2, T3, TNext> AndBehaviour<TNext>()
            where TNext : SingletonAppalachiaBehaviour<TNext>, ISingleton<TNext>
        {
            using (_PRF_AndBehaviour.Auto())
            {
        ...
        public IAvailabilitySet<T1, T2, T3, TNext> AndObject<TNext>()
            where TNext : SingletonAppalachiaObject<TNext>, ISingleton<TNext>
        {
            using (_PRF_AndObject.Auto())
            {
        ...
        private const string _PRF_PFX = nameof(AvailabilitySet<T1, T2, T3>) + ".";
