...
{
    public class AvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9> :
        BaseAvailabilitySetOf<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>>,
        IAvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9>
    {
        ...
        public void CopyTo(AvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9> other)
        {
        ...
        protected override void OnFullyAvailable(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> action)
        {
        ...
        private IAvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9, TNext> And<TNext>(
            Func<AvailabilityData<TNext>> newDataFunction)
        {
            using (_PRF_And.Auto())
            {
                var result = new AvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9, TNext>(SortOrder)
                {
                    Data1 = Data1,
                    Data2 = Data2,
                    Data3 = Data3,
                ...
                result.Data10.AvailabilityChanged.Event -= OnAvailabilityChanged;
                ...
                result.Data10.AvailabilityChanged.Event += result.OnAvailabilityChanged;

                return result;
            }
        }

        #region IAvailabilitySet<T1,T2,T3,T4,T5,T6,T7,T8,T9> Members

        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9, TNext> AndBehaviour<TNext>(TNext unused)
        ...
        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9, TNext> AndObject<TNext>(TNext unused)
            where TNext : SingletonAppalachiaObject<TNext>, ISingleton<TNext>
        {
            return And(() => AvailabilityData<TNext>.ForObject<TNext>(SortOrder));
        }

        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9, TNext> AndBehaviour<TNext>()
            where TNext : SingletonAppalachiaBehaviour<TNext>, ISingleton<TNext>
        {
            return And(() => AvailabilityData<TNext>.ForBehaviour<TNext>(SortOrder));
        }

        public IAvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9, TNext> AndObject<TNext>()
            where TNext : SingletonAppalachiaObject<TNext>, ISingleton<TNext>
        {
            return And(() => AvailabilityData<TNext>.ForObject<TNext>(SortOrder));
        }
        ...
        private const string _PRF_PFX = nameof(AvailabilitySet<T1, T2, T3, T4, T5, T6, T7, T8, T9>) + ".";
