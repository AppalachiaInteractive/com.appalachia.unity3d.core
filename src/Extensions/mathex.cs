    ...
    public static class mathex
    {
        ...
        public static float angle(float3 from, float3 to)
        {
            ...
            return num < 1.00000000362749E-15
                ? 0.0f
                : (float) math.acos((double) math.clamp(math.dot(from, to) / num, -1f, 1f)) *
                  57.29578f;
        }
        ...
        {
            return new(normalize(value.x, low.x, high.x), normalize(value.y, low.y, high.y),
                normalize(value.z,        low.z, high.z), normalize(value.w, low.w, high.w));
        }
        ...
        public static Vector3 normalize(
            ...
            Vector2 rangeZ)
        {
            return new(normalize(value.x, rangeX.x, rangeX.y), normalize(
                value.y,
                rangeY.x,
                rangeY.y
