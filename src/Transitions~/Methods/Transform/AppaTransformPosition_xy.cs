namespace Appalachia.Core.Transitions.Methods.Transform
{
    ...
    [UnityEngine.AddComponentMenu(
        ...
        nameof(AppaTransformPosition_xy)
    )]
    public class AppaTransformPosition_xy : AppaMethodWithStateAndTarget
    {
        ...
        public class State : AppaTransitionStateWithTarget<UnityEngine.Transform>
        {
            ...
            public override int CanFill =>
                (Target != null) && ((Target.position.x != Value.x) || (Target.position.y != Value.y))
                    ? 1
                    : 0;
