namespace Appalachia.Core.Transitions.Methods.RectTransform
{
    ...
    [UnityEngine.AddComponentMenu(
        ...
        nameof(AppaRectTransformSizeDelta)
    )]
    public class AppaRectTransformSizeDelta : AppaMethodWithStateAndTarget
    {
        ...
        public class State : AppaTransitionStateWithTarget<UnityEngine.RectTransform>
        {
            ...
            [UnityEngine.Serialization.FormerlySerializedAs("SizeDelta")]
