namespace Appalachia.Core.Transitions.Methods.Graphic
{
    ...
    [UnityEngine.AddComponentMenu(
        ...
        nameof(AppaGraphicColor)
    )]
    public class AppaGraphicColor : AppaMethodWithStateAndTarget
    {
        ...
        [System.Serializable]
        public class State : AppaTransitionStateWithTarget<UnityEngine.UI.Graphic>
        {
